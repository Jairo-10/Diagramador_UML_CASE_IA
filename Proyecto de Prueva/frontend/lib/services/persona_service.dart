...
class PersonaService {
  ...
  Future<Persona> create(Persona item) async {
    try {
      ...
      if (response.statusCode == 201 || response.statusCode == 200) {
        ...
        throw Exception('Error al crear Persona: ${response.statusCode} - ${response.body}');
      }
    } catch (e) {
      throw Exception('Error de conexión: $e');
    }
  ...
  Future<Persona> update(String id, Persona item) async {
    try {
      ...
      if (response.statusCode == 200) {
        ...
        throw Exception('Error al actualizar Persona: ${response.statusCode} - ${response.body}');
      }
    } catch (e) {
      throw Exception('Error de conexión: $e');
    }
