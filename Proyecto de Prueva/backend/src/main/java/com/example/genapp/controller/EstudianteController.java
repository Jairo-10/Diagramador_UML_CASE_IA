...
import com.example.genapp.service.EstudianteService;
...
public class EstudianteController {
    ...
    @GetMapping("/{id}")
    public Estudiante one(@PathVariable("id") String id) {
    return service.findById(id)
    .orElseThrow(() -> new RuntimeException("Estudiante not found with id " + id));
    }

    @PostMapping
    public Estudiante create(@RequestBody Map<String, Object> body) {
    ...
    @PutMapping("/{id}")
    public Estudiante update(@PathVariable("id") String id, @RequestBody Map<String, Object> updates) {
        // Verificar que el recurso existe antes de actualizar
        Estudiante existing = service.findById(id)
            .orElseThrow(() -> new RuntimeException("Estudiante not found with id " + id));
    ...
    private void updateEntityFromMap(Estudiante entity, Map<String, Object> data) {
